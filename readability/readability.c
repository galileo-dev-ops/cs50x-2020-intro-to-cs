...
int main(void)
{
    string text = get_string("Input your text here, then press enter: ");
    ...
    if (index >= 16)
    {
        printf("This can be comprehended by Grade 16+\n");
    }
    else if (index <= 1)
    {
        printf("This can be comprehended by people before Grade 1\n");
    }
    else
    {
        printf("This can be comprehended by Grade %i\n", (int)round(index));
    }
}